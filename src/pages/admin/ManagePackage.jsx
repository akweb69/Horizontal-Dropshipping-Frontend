    ...
    const updateStatus = async () => {
        ...
        try {
            const response = await axios.patch(
                ...
                { packageStatus: newStatus, email: selectedPackage.email, planName: selectedPackage.planName, storeInfo: selectedPackage.storeInfo, validityDays: selectedPackage.validityDays, bonusAmountForUser: selectedPackage.discountAmount }
            );
            if (response.data) {
