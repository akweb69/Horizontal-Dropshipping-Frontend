...
const HeroSection = () => {
  ...
  // laod all slides data-->
  useEffect(() => {
    setLoading(true);
    axios.get(`${import.meta.env.VITE_BASE_URL}/hero-section-banner`)
      .then(res => {
        setSlides(res.data)
        setLoading(false)
  ...
  return (
    ...
    >
      {loading ? <div className="w-full min-h-[50vh] md:min-h-[70vh] flex items-center justify-center">loading... </div> : <div className="">
